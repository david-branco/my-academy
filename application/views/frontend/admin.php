...
<h2 style ="display: inline">Users</h2><a href="<?php echo base_url() . "index.php/teacher/form/"; ?>"><button style ="margin-left: 10px;" type="button" class="btn btn-primary btn-xs">Add new</button></a>
        ...
        <tr>
            <td>
                <div style="overflow: hidden">
                    <?php
                        if (empty($docente->foto)) { echo "<img border=\"0\" src=\" " .base_url()."uploads/photos/defaultphoto.png\" alt=\"User Default Photo\" width=\"40\" height=\"30\"/>"; }
                        else { echo "<img border=\"0\" src=\" " . base_url() . $docente->foto . "\" alt=\"Teacher Photo\" width=\"40\" height=\"30\"/>"; }
                    ?>
                </div>
            </td>
            <td><div style="overflow: hidden"><?php echo $docente->nome ?></div></td>
            <td><div style="overflow: hidden"><?php echo $docente->email ?></div></td>
            <td><div style="overflow: hidden"><?php echo $docente->website ?></div></td>
            <td>
                <a href="<?php echo base_url() . "index.php/teacher/profile/" . $docente->docente_id; ?>"><button type="button" class="btn btn-info btn-xs">Show</button></a>
                <a href="<?php echo base_url() . "index.php/teacher/form/" . $docente->docente_id; ?>"><button type="button" class="btn btn-warning btn-xs">Edit</button></a>
                <a href="<?php echo base_url() . "index.php/teacher/delete/" . $docente->docente_id; ?>"><button type="button" class="btn btn-danger btn-xs">Delete</button></a>
            </td>
        </tr>
        <?php } ?>
    </tbody>
